...
var ads = '<div style="padding: 0.3em 0.3em; padding-top: 0;"><div style="background: #3e3e3e; padding: 0.5em; border-radius: 1em;"><div style="line-height: 1.2;"><span style="color: #ffffff"><div style="text-align: center;">             [>>>L<<<]             <br> ДЛЯ ОЗНАКОМИТЕЛЬНОГО</br><br>	НЕКОММЕРЧЕСКОГО</br><br>	ИСПОЛЬЗОВАНИЯ</br><span style="color: #f3d900">@lampa_plugins_uncensored</span></span></div></div></div></div>'	
...
/* Интерфейс */
		...
		Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
							itemON('http://cub.red/plugin/tmdb-proxy', 'TMDB Proxy', '@lampa-l', 'TMDB');
						}
						if (value == '2') {
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://bylampa.github.io/cub_off.js', 'Cub Off', '@scabrum-l', 'Cub_off');
						}
						if (value == '2') {
...
/* Управление */
		...
		Lampa.SettingsApi.addParam({
	        ...
	        Lampa.SettingsApi.addParam({
					...
					onChange: function(value) {
						if (value == '1') {
						       itemON('https://bylampa.github.io/redirect.js', 'Смена Сервера', '@scabrum-l', 'Redirect');
						}
						if (value == '2') {
